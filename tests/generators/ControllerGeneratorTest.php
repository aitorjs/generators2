...
use Buruframe\Generators\Generators\ControllerGenerator;
use Mockery as m;
...
class ControllerGeneratorTest extends PHPUnit_Framework_TestCase {
    ...
    {
        static::$templatesDir = __DIR__.'/../../src/Buruframe/Generators/Generators/templates';
    }
    ...
    public function testCanGenerateControllerUsingDefaultTemplate()
    {
        ...
        $cache = m::Mock('Buruframe\Generators\Cache');
