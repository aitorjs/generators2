...
use Buruframe\Generators\Generators\FormDumperGenerator;
...
class FormDumperGeneratorTest extends PHPUnit_Framework_TestCase {
    ...
    {
        $form = m::mock('Buruframe\Generators\Generators\FormDumperGenerator', array(new File, new Mustache))->makePartial();
