...
use Buruframe\Generators\Commands\ControllerGeneratorCommand;
...
class ControllerGeneratorCommandTest extends PHPUnit_Framework_TestCase {
    ...
    {
        $gen = m::mock('Buruframe\Generators\Generators\ControllerGenerator');
    ...
    {
        $gen = m::mock('Buruframe\Generators\Generators\ControllerGenerator[make]');
